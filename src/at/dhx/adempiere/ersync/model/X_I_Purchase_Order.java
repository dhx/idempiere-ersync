...
/** Generated Model for I_Purchase_Order
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_I_Purchase_Order extends PO implements I_I_Purchase_Order, I_Persistent 
{
    ...
    {
      super (ctx, I_Purchase_Order_ID, trxName);
      /** if (I_Purchase_Order_ID == 0)
        {
			setI_IsImported (false);
// N
			setI_Purchase_Order_ID (0);
        } */
    }

    /** Load Constructor */
    public X_I_Purchase_Order (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_Purchase_Order[")
	...
	/** Set Import Purchase Order.
		@param I_Purchase_Order_ID Import Purchase Order	  */
	public void setI_Purchase_Order_ID (int I_Purchase_Order_ID)
	{
		if (I_Purchase_Order_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_Purchase_Order_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_Purchase_Order_ID, Integer.valueOf(I_Purchase_Order_ID));
	}

	/** Get Import Purchase Order.
		@return Import Purchase Order	  */
	public int getI_Purchase_Order_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_Purchase_Order_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_Purchase_Order_UU.
		@param I_Purchase_Order_UU I_Purchase_Order_UU	  */
	public void setI_Purchase_Order_UU (String I_Purchase_Order_UU)
	{
		set_Value (COLUMNNAME_I_Purchase_Order_UU, I_Purchase_Order_UU);
	}

	/** Get I_Purchase_Order_UU.
		@return I_Purchase_Order_UU	  */
	public String getI_Purchase_Order_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_Purchase_Order_UU);
	}
