...
/** Generated Model for I_Web_Order
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_I_Web_Order extends PO implements I_I_Web_Order, I_Persistent 
{
    ...
    {
      super (ctx, I_Web_Order_ID, trxName);
      /** if (I_Web_Order_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_I_Web_Order (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_Web_Order[")
	...
	/** Set Import Web Order.
		@param I_Web_Order_ID Import Web Order	  */
	public void setI_Web_Order_ID (int I_Web_Order_ID)
	{
		if (I_Web_Order_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_Web_Order_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_Web_Order_ID, Integer.valueOf(I_Web_Order_ID));
	}

	/** Get Import Web Order.
		@return Import Web Order	  */
	public int getI_Web_Order_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_Web_Order_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_Web_Order_UU.
		@param I_Web_Order_UU I_Web_Order_UU	  */
	public void setI_Web_Order_UU (String I_Web_Order_UU)
	{
		set_Value (COLUMNNAME_I_Web_Order_UU, I_Web_Order_UU);
	}

	/** Get I_Web_Order_UU.
		@return I_Web_Order_UU	  */
	public String getI_Web_Order_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_Web_Order_UU);
	}
