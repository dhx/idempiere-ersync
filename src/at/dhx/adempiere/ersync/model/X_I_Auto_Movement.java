...
/** Generated Model for I_Auto_Movement
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_I_Auto_Movement extends PO implements I_I_Auto_Movement, I_Persistent 
{
    ...
    {
      super (ctx, I_Auto_Movement_ID, trxName);
      /** if (I_Auto_Movement_ID == 0)
        {
			setI_Auto_Movement_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_I_Auto_Movement (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_Auto_Movement[")
	...
	/** Set Import Automatic Movement.
		@param I_Auto_Movement_ID Import Automatic Movement	  */
	public void setI_Auto_Movement_ID (int I_Auto_Movement_ID)
	{
		if (I_Auto_Movement_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_Auto_Movement_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_Auto_Movement_ID, Integer.valueOf(I_Auto_Movement_ID));
	}

	/** Get Import Automatic Movement.
		@return Import Automatic Movement	  */
	public int getI_Auto_Movement_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_Auto_Movement_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set I_Auto_Movement_UU.
		@param I_Auto_Movement_UU I_Auto_Movement_UU	  */
	public void setI_Auto_Movement_UU (String I_Auto_Movement_UU)
	{
		set_Value (COLUMNNAME_I_Auto_Movement_UU, I_Auto_Movement_UU);
	}

	/** Get I_Auto_Movement_UU.
		@return I_Auto_Movement_UU	  */
	public String getI_Auto_Movement_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_Auto_Movement_UU);
	}
