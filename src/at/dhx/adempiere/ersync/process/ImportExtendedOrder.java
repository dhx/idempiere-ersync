...
public class ImportExtendedOrder extends SvrProcess {
	...
	protected String doIt() throws java.lang.Exception {
		...
		sql = new StringBuilder("UPDATE ")
				.append(getM_TableName())
				.append(" ")
				.append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||'ERR=Artikel nicht gefunden, ' ")
		...
		sql = new StringBuilder("UPDATE ")
				.append(getM_TableName())
				.append(" o ")
				.append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||'ERR=Artikel in keiner aktuellen Preisliste vorhanden, ' ")
		...
		sql = new StringBuilder("UPDATE ")
				.append(getM_TableName())
				.append(" ")
				.append("SET I_IsImported='E', I_ErrorMsg=I_ErrorMsg||'ERR=Steuerkurzbezeichnung nicht gefunden, ' ")
